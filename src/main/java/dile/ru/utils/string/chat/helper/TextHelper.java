package dile.ru.utils.string.chat.helper;

import net.minecraft.network.chat.Component;
import net.minecraft.network.chat.MutableComponent;
import dile.ru.api.module.impl.visual.ClickGuiModule;
import dile.ru.utils.color.ColorAssist;
...
public class TextHelper {
    ...
    public static Component applyPredefinedGradient(String text, String gradientName, boolean bold) {
        ...
        return switch (gradient) {
            ...
            case "theme_color" -> applyGradient(text, GradientStyle.FULL_GRADIENT, ColorAssist.colorForRectsBlack$(), ClickGuiModule.getInstance().getColor(), bold);
