package dile.ru.utils.string.chat;
...
import dile.ru.utils.string.chat.helper.TextHelper;
...
public final class ChatMessage {
    ...
    public static MutableComponent brandmessage() {
        return (MutableComponent) TextHelper.applyPredefinedGradient("Dile", "theme_color", true);
    }
    ...
    public static void brandmessage(Component message) {
        ...
        if (mc.player != null) {
            Component prefix = TextHelper.applyPredefinedGradient("Dile Client -> ", "theme_color", true);
    ...
    private static void prefixed(String prefixText, Component message) {
        Minecraft mc = Minecraft.getInstance();
        if (mc.player != null) {
            Component prefix = TextHelper.applyPredefinedGradient(prefixText, "theme_color", true);
