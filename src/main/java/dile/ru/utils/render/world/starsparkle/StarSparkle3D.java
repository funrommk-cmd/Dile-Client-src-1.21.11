package dile.ru.utils.render.world.starsparkle;
    ...
    public static void init() {
        ...
        try {
            ...
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.fromNamespaceAndPath("dile", "pipeline/world/starsparkle"))
                    .withVertexShader(Identifier.fromNamespaceAndPath("dile", "world/shared/particle_billboard"))
                    .withFragmentShader(Identifier.fromNamespaceAndPath("dile", "world/starsparkle/starsparkle"))
