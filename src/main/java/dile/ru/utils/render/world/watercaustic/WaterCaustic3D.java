package dile.ru.utils.render.world.watercaustic;
    ...
    public static void init() {
        ...
        try {
            ...
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.fromNamespaceAndPath("dile", "pipeline/world/watercaustic"))
                    .withVertexShader(Identifier.fromNamespaceAndPath("dile", "world/shared/particle_billboard"))
                    .withFragmentShader(Identifier.fromNamespaceAndPath("dile", "world/watercaustic/watercaustic"))
