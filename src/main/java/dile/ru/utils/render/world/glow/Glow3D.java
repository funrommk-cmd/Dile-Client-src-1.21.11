package dile.ru.utils.render.world.glow;
...
public final class Glow3D {
    ...
    private static final int MAX_GLOWS = 4096;
    ...
    public static void init() {
        if (pipeline != null && pipelineNoDepth != null) {
            return;
        }
        ...
        pipeline = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath("dile", "pipeline/world/glow3d"))
                .withVertexShader(Identifier.fromNamespaceAndPath("dile", "world/glow3d/glow3d"))
                .withFragmentShader(Identifier.fromNamespaceAndPath("dile", "world/glow3d/glow3d"))
        ...
        pipelineNoDepth = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath("dile", "pipeline/world/glow3d_through"))
                .withVertexShader(Identifier.fromNamespaceAndPath("dile", "world/glow3d/glow3d"))
                .withFragmentShader(Identifier.fromNamespaceAndPath("dile", "world/glow3d/glow3d"))
                .withVertexFormat(format, VertexFormat.Mode.TRIANGLES)
                .withUniform("Uniforms", UniformType.UNIFORM_BUFFER)
    ...
    public static void end() {
        if (pipeline == null || pipelineNoDepth == null || uniformBuffer == null || vertexBuffer == null || glowCount == 0) {
            return;
        }
        ...
        try {
            ...
            GpuTextureView depthView = ignoreDepth ? null : framebuffer.getDepthTextureView();
