...
public final class ClientPipelines {
    ...
    public static final RenderPipeline SKIN_TRIANGLE_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(MATRICES_PROJECTION_SNIPPET)
                    .withLocation("pipeline/skin_triangle")
                    .withVertexShader("core/position_tex_color")
                    .withFragmentShader("core/position_tex_color")
                    .withSampler("Sampler0")
                    .withBlend(BlendFunction.TRANSLUCENT)
    ...
    public static final Function<Identifier, RenderType> SKIN_TRIANGLE =
            Util.memoize(texture -> RenderLayerFactory.create("skin_triangle", 512, SKIN_TRIANGLE_PIPELINE, texture));

    public static final RenderPipeline SKIN_BOX_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(MATRICES_PROJECTION_SNIPPET)
                    .withLocation("pipeline/skin_box")
                    .withVertexShader("core/position_tex_color")
                    .withFragmentShader("core/position_tex_color")
                    .withSampler("Sampler0")
                    .withBlend(BlendFunction.TRANSLUCENT)
    ...
    public static final Function<Identifier, RenderType> SKIN_BOX =
            Util.memoize(texture -> RenderLayerFactory.create("skin_box", 512, SKIN_BOX_PIPELINE, texture));
    ...
    public static final RenderPipeline CHINA_HAT_SIDES_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(MATRICES_PROJECTION_SNIPPET)
                    .withLocation("pipeline/china_hat_sides")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
                    .withBlend(BlendFunction.TRANSLUCENT)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
    ...
    public static final RenderType CHINA_HAT_SIDES = RenderLayerFactory.create("china_hat_sides", 8192, CHINA_HAT_SIDES_PIPELINE);
