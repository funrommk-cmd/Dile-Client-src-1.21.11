package dile.ru.utils.render.ui.font;
...
final class FontManager implements AutoCloseable {
    ...
    private static final String FONT_ROOT = "/assets/dile/ui/fonts/";
    ...
    private void load() {
        ...
        Font montserrat = loadFont("montserrat.ttf", openSansSemiBold);
        ...
        register("montserrat", montserrat);
        register(FontType.MONT, montserrat);
        ...
        register("icon", icons);
        register("target", loadFont("target.ttf", icons));
        ...
        register(FontType.HUD2, icons);
        register(FontType.ICONS_NURIK, icons);
    }
