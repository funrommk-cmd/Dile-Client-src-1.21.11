package dile.ru.utils.render.ui.msdf;
...
public final class MsdfIconRenderer implements AutoCloseable {
    ...
    public void draw(
        ...
        try {
            GuiRenderState guiState = ((GuiGraphicsExtractorAccessor) activeGraphics).dile$getGuiRenderState();
    ...
    private Atlas load(FontType font) {
        ...
        Identifier jsonId = Identifier.fromNamespaceAndPath("dile", "ui/msdf/" + font.path() + ".json");
    ...
    private TextureSetup textureSetup(FontType font, Atlas atlas) {
        ...
        Identifier textureId = Identifier.fromNamespaceAndPath("dile", "ui/msdf/" + font.path() + ".png");
