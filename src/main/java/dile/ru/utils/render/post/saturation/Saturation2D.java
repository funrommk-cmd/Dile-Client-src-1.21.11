package dile.ru.utils.render.post.saturation;
...
public class Saturation2D {
    ...
    private static final Identifier PIPELINE_ID = Identifier.fromNamespaceAndPath("dile", "pipeline/post/saturation");
    private static final Identifier VERTEX_SHADER = Identifier.fromNamespaceAndPath("dile", "post/saturation/saturation");
    private static final Identifier FRAGMENT_SHADER = Identifier.fromNamespaceAndPath("dile", "post/saturation/saturation");
