package dile.ru.utils.inventory.lookup;


import dile.ru.mixin.accessor.ClientWorldAccessor;
...
public final class InventoryUtils {
    ...
    public static boolean syncSelectedHotbarSlot(int slot) {
        ...
        mc.player.getInventory().setSelectedSlot(slot);
        ((MultiPlayerGameModeAccessor) mc.gameMode).dile$ensureHasSentCarriedItem();
