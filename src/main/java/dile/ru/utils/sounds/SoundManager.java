...
public final class SoundManager {
    ...
    public static final SoundEvent CLICK_KEY = sound("click_key");
    public static final SoundEvent CLICK_SLIME = sound("click_slime");
    public static final SoundEvent CLICK_CREAM = sound("click_cream");
    public static final SoundEvent CLICK_WATER = sound("click_water");
    ...
    public static void init() {
        ...
        register(CLICK_KEY);
        register(CLICK_SLIME);
        register(CLICK_CREAM);
        register(CLICK_WATER);
    }
    ...
    private static SoundEvent sound(String path) {
        return SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath("dile", path));
    }
