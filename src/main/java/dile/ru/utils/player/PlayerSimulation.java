...
import dile.ru.mixin.accessor.EntityAccessor;
...
public class PlayerSimulation implements Simulation, IMinecraft {
    ...
    public static PlayerSimulation fromClientPlayer(SimulatedPlayerInput input) {
        ...
        return new PlayerSimulation(
                ...
                livingAccessor.dile$getJumpingCooldown(),
                livingAccessor.dile$isJumping(),
                player.isFallFlying(),
                player.onGround(),
                entityAccessor.dile$isHorizontalCollision(),
                entityAccessor.dile$isVerticalCollision(),
                player.isInWater(),
                player.isSwimming(),
                player.isUnderWater(),
                new Object2DoubleArrayMap<>(entityAccessor.dile$getFluidHeight()),
                new HashSet<>(entityAccessor.dile$getSubmergedFluidTag())
        );
    }
