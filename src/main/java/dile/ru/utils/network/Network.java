...
import dile.ru.mixin.accessor.BossHealthOverlayAccessor;
...
public final class Network {
    ...
    private static void updatePvpState() {
        ...
        Map<?, LerpingBossEvent> events = ((BossHealthOverlayAccessor) MC.gui.getBossOverlay()).dile$getEvents();
