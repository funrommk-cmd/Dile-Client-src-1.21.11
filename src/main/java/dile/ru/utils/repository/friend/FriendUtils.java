package dile.ru.utils.repository.friend;
...
public final class FriendUtils {
    ...
    public static void load() {
        setFriends(RepositoryStorage.loadStringList("friends.dile", "friends"));
    }

    public static void save() {
        RepositoryStorage.saveStringList("friends.dile", "friends", getFriendNames());
    }
