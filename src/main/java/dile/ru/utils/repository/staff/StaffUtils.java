package dile.ru.utils.repository.staff;
...
public final class StaffUtils {
    ...
    public static void load() {
        setStaff(RepositoryStorage.loadStringList("staff.dile", "staff"));
    }

    public static void save() {
        RepositoryStorage.saveStringList("staff.dile", "staff", getStaffNames());
    }
