...
final class ParticleConstants {
    ...
    static final String EVENT_TOTEM = "Totem";
    static final String EVENT_WALK = "Walk";
    ...
    static final String[] EVENT_MODES = new String[]{EVENT_WORLD, EVENT_ATTACKS, EVENT_TOTEM, EVENT_WALK};
    ...
    private static ParticleTexture particle(String mode, String path) {
        return new ParticleTexture(mode, Identifier.fromNamespaceAndPath("dile", ROOT + path));
    }
}
