...
import dile.ru.api.events.impl.SwingDurationEvent;
...
public class SwingAnimation extends Module {
    private final ModeSetting swingType = register(new ModeSetting("Type", "Swing animation type.", "Chop",
            "Chop", "Swipe", "Down", "Smooth", "Smooth 2", "Power", "Feast", "Twist", "Stab", "Helix", "Katana", "Orbit", "Cross Slash", "Uppercut", "Whirlwind", "Dagger", "Default"));
    ...
    private void onHandAnimation(HandAnimationEvent event) {
        if (mc.player == null || isBlockedForSwingAnimation(event.getHand()) || !passesAuraFilter()) {
            return;
        }
        ...
        if (onlySwing.getValue() && mc.player.swingTime == 0) {
            ...
            matrices.mulPose(Axis.YP.rotationDegrees(70 * armSide));
            matrices.mulPose(Axis.ZP.rotationDegrees(2 * armSide));
        } else if (swingType.is("Katana")) {
            matrices.translate(armSide * 0.56F, -0.36F, -0.72F);
            matrices.mulPose(Axis.YP.rotationDegrees(65.0F * armSide));
            matrices.mulPose(Axis.YP.rotationDegrees(sin2 * -40.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(sin2 * -90.0F * strength));
            matrices.mulPose(Axis.ZP.rotationDegrees(sin2 * 15.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(-40.0F));
            matrices.translate(0.1F * armSide, -0.05F, 0.05F);
        } else if (swingType.is("Orbit")) {
            float orbitAngle = swingProgress * 360.0F;
            matrices.translate(armSide * 0.56F, -0.52F, -0.72F);
            matrices.translate(0.0F, sin2 * 0.15F * strength, 0.0F);
            matrices.mulPose(Axis.YP.rotationDegrees(orbitAngle * armSide));
            matrices.mulPose(Axis.ZP.rotationDegrees(sin2 * 25.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(sin2 * -70.0F * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(-50.0F));
            matrices.translate(0.35F * armSide, 0.0F, 0.1F);
            matrices.mulPose(Axis.XP.rotationDegrees(sin1 * 10.0F * strength));
        } else if (swingType.is("Cross Slash")) {
            float phase1 = Mth.clamp(swingProgress * 2.0F, 0.0F, 1.0F);
            float phase2 = Mth.clamp(swingProgress * 2.0F - 1.0F, 0.0F, 1.0F);
            float slash1 = Mth.sin(phase1 * phase1 * Mth.PI);
            float slash2 = Mth.sin(Mth.sqrt(phase2) * Mth.PI);
            matrices.translate(armSide * 0.56F, -0.32F, -0.72F);
            matrices.mulPose(Axis.YP.rotationDegrees(45.0F * armSide));
            matrices.mulPose(Axis.ZP.rotationDegrees((-slash1 + slash2) * 35.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees((slash1 + slash2) * -100.0F * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(-65.0F));
            matrices.mulPose(Axis.YP.rotationDegrees(sin2 * 20.0F * armSide * strength));
            matrices.translate(-0.05F * armSide, 0.0F, 0.0F);
        } else if (swingType.is("Uppercut")) {
            float lift = swingProgress * swingProgress;
            matrices.translate(armSide * 0.56F, -0.32F, -0.72F);
            matrices.translate(0.0F, lift * 0.3F * strength, sin2 * -0.15F * strength);
            matrices.mulPose(Axis.YP.rotationDegrees(60.0F * armSide));
            matrices.mulPose(Axis.XP.rotationDegrees(sin2 * -110.0F * strength));
            matrices.mulPose(Axis.ZP.rotationDegrees(sin1 * 20.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(sin1 * 30.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(-30.0F));
            matrices.translate(0.1F * armSide, -0.15F, 0.0F);
        } else if (swingType.is("Whirlwind")) {
            float spin = swingProgress * 720.0F;
            float wobble = Mth.sin(swingProgress * 4.0F * Mth.PI) * 0.5F;
            matrices.translate(armSide * 0.56F, -0.36F, -0.72F);
            matrices.mulPose(Axis.YP.rotationDegrees(70.0F * armSide));
            matrices.mulPose(Axis.XP.rotationDegrees(sin2 * -30.0F * strength));
            matrices.mulPose(Axis.ZP.rotationDegrees(spin * armSide * strength * 0.15F));
            matrices.mulPose(Axis.YP.rotationDegrees(sin2 * 60.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(wobble * -25.0F * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(-60.0F));
            matrices.translate(0.2F * armSide, -0.05F, 0.08F);
            matrices.mulPose(Axis.YP.rotationDegrees(sin1 * 15.0F * armSide));
        } else if (swingType.is("Dagger")) {
            float snap = (float) Math.pow(swingProgress, 0.3F);
            float recoil = Mth.sin(Mth.sqrt(swingProgress) * Mth.PI);
            matrices.translate(armSide * 0.62F, -0.28F, -0.88F);
            matrices.mulPose(Axis.YP.rotationDegrees(20.0F * armSide));
            matrices.mulPose(Axis.YP.rotationDegrees(sin2 * 100.0F * armSide * strength));
            matrices.mulPose(Axis.XP.rotationDegrees(sin2 * -20.0F * strength));
            matrices.mulPose(Axis.ZP.rotationDegrees(recoil * -15.0F * armSide * strength));
            matrices.mulPose(Axis.YP.rotationDegrees(55.0F * armSide));
            matrices.mulPose(Axis.XP.rotationDegrees(-85.0F));
            matrices.translate(-0.05F * armSide, -0.05F, snap * -0.08F * strength);
            matrices.mulPose(Axis.ZP.rotationDegrees(sin1 * 5.0F * armSide));
        }
    ...
    private boolean isExcludedSwingItem(ItemStack stack) {
        ...
        if (stack.getItem() instanceof CrossbowItem || stack.getItem() instanceof TridentItem || stack.getItem() instanceof MapItem) {
            return true;
        }
