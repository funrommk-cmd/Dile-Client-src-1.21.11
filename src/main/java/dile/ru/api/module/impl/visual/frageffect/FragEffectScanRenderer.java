package dile.ru.api.module.impl.visual.frageffect;
...
import dile.ru.utils.render.FullscreenQuadBuffer;
...
public final class FragEffectScanRenderer {
    ...
    private static final Identifier PIPELINE_ID = Identifier.fromNamespaceAndPath("dile", "pipeline/effects/frag_effect_scan");
    private static final Identifier VERTEX_SHADER = Identifier.fromNamespaceAndPath("dile", "effects/frag_effect_scan/frag_effect_scan");
    private static final Identifier FRAGMENT_SHADER = Identifier.fromNamespaceAndPath("dile", "effects/frag_effect_scan/frag_effect_scan");
    ...
    private static void init() {
        try {
            ...
            uniformBuffer = RenderSystem.getDevice().createBuffer(
                    () -> "dile:frag_effect_scan_uniforms",
    ...
    private static void renderWave(CommandEncoder encoder, GpuTextureView colorTexture, GpuTextureView depthTexture, Matrix4f inverseProjection, Matrix4f inverseView,
        ...
        try {
            ...
            try (RenderPass pass = encoder.createRenderPass(() -> "dile:frag_effect_scan", colorTexture, OptionalInt.empty())) {
