...
public class Cooldowns extends HudPanel {
    ...
    private void renderCooldowns(CooldownsState state) {
        ...
        int purple = ColorUtil.withAlpha(themeCol, Math.round(255.0F * state.alpha));
        ...
        if (glowAlpha > 0) {
            HudRenderCompat.glow("dile:textures/particles/ghost-glow.png", glowX, glowY - 7.5F, glowSize , glowSize + 15, 0.0F, glow);
        }
