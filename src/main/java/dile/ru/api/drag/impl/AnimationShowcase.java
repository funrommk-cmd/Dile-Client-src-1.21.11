...
import dile.ru.utils.render.animation.fx.AnimationFxMath;
import dile.ru.utils.render.animation.fx.AnimationFxProfile;
...
public final class AnimationShowcase extends HudPanel {
    ...
    private static final int[] FALLBACK = {
            ...
            ColorUtil.rgba(180, 100, 190, 255),
    ...
    private int getColor(int index) {
        if (ClickGuiModule.getInstance() != null) {
            return index == 0 ? ClickGuiModule.getInstance().getColor()
                    : index == 1 ? ClickGuiModule.getInstance().getDimmedColor(1.2F)
