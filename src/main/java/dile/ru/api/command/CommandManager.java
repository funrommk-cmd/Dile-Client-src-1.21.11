package dile.ru.api.command;

import net.minecraft.ChatFormatting;
import net.minecraft.client.Minecraft;
import net.minecraft.network.chat.Component;
import dile.ru.api.command.impl.BindCommand;
import dile.ru.api.command.impl.BlockESPCommand;
import dile.ru.api.command.impl.ConfigCommand;
import dile.ru.api.command.impl.FriendCommand;
import dile.ru.api.command.impl.HelpCommand;
import dile.ru.api.command.impl.MacroCommand;
import dile.ru.api.command.impl.PrefixCommand;
import dile.ru.api.command.impl.PlayerCoordsCommand;
import dile.ru.api.command.impl.StaffCommand;
import dile.ru.api.command.impl.TPCommand;
import dile.ru.api.command.impl.VClipCommand;
import dile.ru.api.command.impl.WayCommand;
import dile.ru.api.events.annotation.SubscribeEvent;
import dile.ru.api.events.impl.ChatEvent;
import dile.ru.api.events.impl.TabCompleteEvent;
import dile.ru.utils.repository.RepositoryStorage;
import dile.ru.utils.string.chat.ChatMessage;
...
public final class CommandManager {
    ...
    public void init() {
        com.google.gson.JsonObject prefixConfig = RepositoryStorage.readObject("prefix.dile");
        ...
        registerCommand(new PlayerCoordsCommand());
    ...
    public void setPrefix(String prefix) {
        ...
        RepositoryStorage.write("prefix.dile", object);
    }
